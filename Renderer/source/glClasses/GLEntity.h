...
protected:
   glm::mat4 model; 
   std::function<void(glm::mat4&, const Material*, const float&)> updateLambda;
...
public:
   ...
   void setUpdateLambda(std::function<void(glm::mat4&, const Material*, const float&)> updateLambda);
